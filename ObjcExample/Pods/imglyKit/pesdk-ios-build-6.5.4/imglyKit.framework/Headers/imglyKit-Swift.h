...
/// Options for the <code>AdjustToolController</code>.
- (void)configureAdjustToolController:(SWIFT_NOESCAPE void (^ _Nonnull)(IMGLYAdjustToolControllerOptionsBuilder * _Nonnull))builder SWIFT_AVAILABILITY(ios,introduced=9.0);
/// Options for the <code>BrushToolController</code>.
